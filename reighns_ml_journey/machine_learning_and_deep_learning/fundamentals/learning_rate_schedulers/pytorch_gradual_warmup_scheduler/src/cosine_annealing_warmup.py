...
class CosineAnnealingWarmupRestarts(_LRScheduler):
    """
        IMPORTANT: When the warmup stops, I changed this source code from (self.cur_cycle_steps - self.warmup_steps) to
        self.cur_cycle_steps to match PyTorch's implementation. The learning rate after warmup will match the PyTorch's
